...
RESOURCES += src/qt/qdp.qrc src/qt/qdp_locale.qrc

TRANSLATIONS += src/qt/locale/qdp_bg.ts \
                src/qt/locale/qdp_de.ts \
                src/qt/locale/qdp_en.ts \
                src/qt/locale/qdp_es.ts \
                src/qt/locale/qdp_fi.ts \
                src/qt/locale/qdp_fr.ts \
                src/qt/locale/qdp_it.ts \
                src/qt/locale/qdp_ja.ts \
                src/qt/locale/qdp_pl.ts \
                src/qt/locale/qdp_pt.ts \
                src/qt/locale/qdp_ru.ts \
                src/qt/locale/qdp_sk.ts \
                src/qt/locale/qdp_sv.ts \
                src/qt/locale/qdp_vi.ts \
                src/qt/locale/qdp_zh_CN.ts \
                src/qt/locale/qdp_zh_TW.ts
