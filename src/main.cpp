...
#if defined(NDEBUG)
#error "QDP cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "QDP Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0) return 900001 * COIN;
...
/*
    if (block.IsProofOfWork() && (pindexPrev->nHeight + 1 <= 691200)) {
