...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("QDP Core qdp-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  qdp-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded qdp transaction") + "\n" +
                               "  qdp-tx [options] -create [commands]   " + _("Create hex-encoded qdp transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded qdp transaction
