                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("QDP-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a QDP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and qdp: URIs)"));
...
//Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About QDP Core"), this);
    aboutAction->setStatusTip(tr("Show information about QDP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for QDP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your QDP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified QDP addresses"));
    ...
    openAction->setStatusTip(tr("Open a QDP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the QDP Core help message to get a list with possible QDP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("QDP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to QDP network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count)
{
	...
	LogPrintf("masternodeSync.IsBlockchainSynced() = %s masternodeSync.IsSynced() = %s \n",masternodeSync.IsBlockchainSynced(),masternodeSync.IsSynced());
    if (masternodeSync.IsBlockchainSynced()) {
        ...
        if (masternodeSync.IsSynced()) {
            ...
            progressBar->setMaximum(4 * MASTERNODE_SYNC_THRESHOLD);//2*4=8
...
{
    QString strTitle = tr("QDP Core"); // default title
