...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    pixPaint.setFont(QFont(font, 26 * fontFactor)); //26
    ...
    /*
    pixPaint.setFont(QFont(font, 20 * fontFactor)); //28
    ...
    */
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 24, copyrightTextQDP);
    */
