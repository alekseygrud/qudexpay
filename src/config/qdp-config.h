/* src/config/qdp-config.h.  Generated from qdp-config.h.in by configure.  */
/* src/config/qdp-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://qdp.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "QDP Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "QDP Core 2.0.0"
