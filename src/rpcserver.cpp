...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* QDP features */
        {"qdp", "masternode", &masternode, true, true, false},
        {"qdp", "masternodelist", &masternodelist, true, true, false},
        {"qdp", "mnbudget", &mnbudget, true, true, false},
        {"qdp", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"qdp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"qdp", "mnsync", &mnsync, true, true, false},
        {"qdp", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"qdp", "Obfuscation", &Obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use qdpd, or the -server option to qdp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> qdp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:58266/\n";
}
