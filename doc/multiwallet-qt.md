...
In order to support loading of multiple wallets in qdp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is qdp.cpp.
...
Changes to qdp.cpp
----------------------
qdp.cpp is the entry point into qdp-qt, and as such, will require some minor modifications to provide hooks for
